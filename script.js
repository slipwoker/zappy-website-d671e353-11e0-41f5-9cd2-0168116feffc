    ...
    "translations": {
      "he": {
        "consentModal": {
          ...
          "description": "המרכז הישראלי לחיסכון משתמש בעוגיות כדי לשפר את החוויה שלך, לנתח שימוש באתר ולסייע במאמצי השיווק שלנו.",
        ...
        function initContactForm() {
            ...
            try {
                ...
                const response = await fetch(endpoint, {
                    ...
                    body: JSON.stringify({
                        websiteId: 'd671e353-11e0-41f5-9cd2-0168116feffc',
                        name: data.name,
                        email: data.email,
